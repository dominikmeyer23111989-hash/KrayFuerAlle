...
def show():
    ...
    # Tabs dynamisch je nach Rechten aufbauen (inkl. Reparatur-Bereich für Berechtigte)
        ...
        with sub_tab2:
            ...
            if aktive_ausleihen:
                ...
                with st.form("rueckgabe_form"):
                    ...
                    # Schadens-Handling bei Rücknahme
    ...
    # ==========================================
    # 4. REPARATUREN & DEFEKTE (Schraubenschlüssel-Ansicht)
    # ==========================================
    if (has_inventar_rights or is_admin_or_vorstand) and tab_reparatur is not None:
        with tab_reparatur:
