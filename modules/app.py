...
from modules import finanzen_page
from modules import inventar_page
...
# --- OBERFLÄCHE FÜR EINGELOGGTE NUTZER ---
    ...
    # Navigation dynamisch nach Rolle aufbauen
    nav_optionen = ["Mitglieder & Rollen", "Inventar & Ausleihe"]
