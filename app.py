...
# --- OBERFLÄCHE FÜR EINGELOGGTE NUTZER (NUR MITGLIEDER) ---
else:
    ...
    # Auf das Wesentliche reduziert: Nur noch Mitglieder & Rollen
    menue = st.sidebar.radio("Navigation", ["Mitglieder & Rollen"])
